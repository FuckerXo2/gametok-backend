...
const GLOBAL_ANTI_PATTERNS = [
    ...
    'Leaving the world a flat empty void — fill it with a code-drawn or CDN background/floor appropriate to the camera',
    ...
    'Rendering different named items/toppings/choices (e.g. Sprinkles vs Candy vs Fruit) with the SAME icon or shape — each distinct type must use its own distinct sprite or code-drawn shape and look visibly different',
