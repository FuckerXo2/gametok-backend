...
export function buildMakerAgentInspectionPrompt({
    ...
    return [
        ...
        'Read the actual project files, compare them to the builder maps and contracts, then make small file edits only if they materially improve GDD/template/asset compliance.',
