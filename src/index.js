...
const seedDatabase = async (force = false) => {
  ...
  const allGames = [
    ...
    { id: '2048-v2', name: '2048 Classic', description: 'Original 2048 experience!', icon: '🔢', color: '#edc22e', category: 'puzzle' },
    { id: 'tetris', name: 'Tetris', description: 'Stack falling blocks! Clear lines to score.', icon: '🧱', color: '#00d4ff', category: 'puzzle' },
    { id: 'hextris', name: 'Hextris', description: 'Hexagonal Tetris! Match colors to clear.', icon: '⬡', color: '#9b59b6', category: 'puzzle' },
    { id: 'hextris-v2', name: 'Hextris Pro', description: 'Advanced hexagonal puzzle action!', icon: '⬡', color: '#8e44ad', category: 'puzzle' },
    { id: 'connect3', name: 'Connect 3', description: 'Match 3 in a row to score!', icon: '💎', color: '#3498db', category: 'puzzle' },
    ...
    { id: 'memory-game-v2', name: 'Memory Pro', description: 'Advanced memory challenge!', icon: '🧠', color: '#9b59b6', category: 'puzzle' },
    { id: 'konnekt', name: 'Konnekt', description: 'Connect the dots puzzle!', icon: '🔗', color: '#1abc9c', category: 'puzzle' },
    { id: 'block-blast', name: 'Block Blast', description: 'Match and blast blocks!', icon: '🟦', color: '#3498db', category: 'puzzle' },
    
    // Arcade
    { id: 'pacman', name: 'Pac-Man', description: 'Eat dots, avoid ghosts! Classic arcade 👻', icon: '🟡', color: '#FFFF00', category: 'arcade' },
    { id: 'flappy-bird', name: 'Flappy Bird', description: 'Tap to flap! Avoid the pipes.', icon: '🐦', color: '#70c5ce', category: 'casual' },
    { id: 'clumsy-bird', name: 'Clumsy Bird', description: 'Another flappy adventure!', icon: '🐤', color: '#f1c40f', category: 'casual' },
    { id: 'clumsy-bird-v2', name: 'Clumsy Bird 2', description: 'More clumsy flying fun!', icon: '🐤', color: '#f39c12', category: 'casual' },
    { id: 'fruit-slicer', name: 'Fruit Slicer', description: 'Swipe to slice fruits! Avoid bombs 💣', icon: '🍉', color: '#ff6b6b', category: 'action' },
    { id: 'piano-tiles', name: 'Piano Tiles', description: 'Tap the black tiles! Dont miss!', icon: '🎹', color: '#1a1a2e', category: 'arcade' },
    { id: 'breakout', name: 'Breakout', description: 'Classic brick breaker!', icon: '🧱', color: '#e74c3c', category: 'arcade' },
    { id: 'breakout-phaser', name: 'Breakout Pro', description: 'Enhanced brick breaking action!', icon: '🧱', color: '#c0392b', category: 'arcade' },
    { id: 'snake-io', name: 'Snake.io', description: 'Grow your snake! Eat orbs.', icon: '🐍', color: '#00d4ff', category: 'arcade' },
    { id: 'doodle-jump', name: 'Doodle Jump', description: 'Jump up platforms!', icon: '🐸', color: '#8bc34a', category: 'casual' },
    { id: 'geometry-dash', name: 'Geometry Dash', description: 'Tap to jump! Avoid obstacles.', icon: '⬛', color: '#00d4ff', category: 'action' },
    { id: 'endless-runner', name: 'Endless Runner', description: 'Run, jump, slide! Collect coins!', icon: '🏃', color: '#ff6b6b', category: 'action' },
    { id: 'crossy-road', name: 'Crossy Road', description: 'Tap to hop! Cross safely.', icon: '🐔', color: '#8bc34a', category: 'casual' },
    { id: 'chromedino', name: 'Chrome Dino', description: 'The classic offline dinosaur game!', icon: '🦖', color: '#535353', category: 'arcade' },
    { id: 'circus-charlie', name: 'Circus Charlie', description: 'Classic circus arcade action!', icon: '🎪', color: '#e74c3c', category: 'retro' },
    
    // Action/Reflex
    { id: 'whack-a-mole', name: 'Whack-a-Mole', description: 'Tap the moles before they hide!', icon: '🐹', color: '#8b4513', category: 'action' },
    { id: 'aim-trainer', name: 'Aim Trainer', description: 'Test your reflexes! Tap targets.', icon: '🎯', color: '#e74c3c', category: 'action' },
    { id: 'reaction-time', name: 'Reaction Time', description: 'How fast can you react?', icon: '⚡', color: '#f1c40f', category: 'action' },
    { id: 'color-match', name: 'Color Match', description: 'Tap the matching color!', icon: '🎨', color: '#f39c12', category: 'puzzle' },
    { id: 'tap-tap-dash', name: 'Tap Tap Dash', description: 'Tap to turn! Stay on path.', icon: '👆', color: '#3498db', category: 'action' },
    { id: 'tap-tap-blue', name: 'Tap Tap Blue', description: 'Tap the blue tiles only!', icon: '🔵', color: '#3498db', category: 'action' },
    { id: 'number-tap', name: 'Number Tap', description: 'Tap numbers in order!', icon: '🔢', color: '#1abc9c', category: 'puzzle' },
    { id: 'bubble-pop', name: 'Bubble Pop', description: 'Pop bubbles before they escape!', icon: '🫧', color: '#00bcd4', category: 'casual' },
    { id: 'simon-says', name: 'Simon Says', description: 'Remember the pattern!', icon: '🔴', color: '#e91e63', category: 'puzzle' },
    { id: 'radiusraid', name: 'Radius Raid', description: 'Defend your radius from enemies!', icon: '🎯', color: '#e74c3c', category: 'action' },
    
    // Sports
    { id: 'basketball', name: 'Basketball', description: 'Swipe to shoot hoops!', icon: '🏀', color: '#f39c12', category: 'sports' },
    ...
    { id: 'pool', name: 'Pool', description: '8-ball billiards!', icon: '🎱', color: '#27ae60', category: 'sports' },
    ...
    // Retro/Space
    { id: 'asteroids', name: 'Asteroids', description: 'Blast asteroids in space!', icon: '☄️', color: '#2c3e50', category: 'retro' },
    ...
    { id: 'spacegarden', name: 'Space Garden', description: 'Grow your space garden!', icon: '🌱', color: '#27ae60', category: 'casual' },
    { id: 'spacecompany', name: 'Space Company', description: 'Build your space empire!', icon: '🏢', color: '#34495e', category: 'strategy' },
    ...
    // Strategy
    { id: 'tic-tac-toe', name: 'Tic Tac Toe', description: 'Classic X and O!', icon: '⭕', color: '#9b59b6', category: 'strategy' },
    { id: 'chess', name: 'Chess', description: 'The ultimate strategy game!', icon: '♟️', color: '#2c3e50', category: 'strategy' },
    { id: 'rock-paper-scissors', name: 'Rock Paper Scissors', description: 'Classic hand game!', icon: '✊', color: '#9b59b6', category: 'casual' },
    { id: 'hearts', name: 'Hearts', description: 'Classic card game!', icon: '♥️', color: '#e74c3c', category: 'strategy' },
    { id: 'untrusted', name: 'Untrusted', description: 'Hack your way through!', icon: '💻', color: '#27ae60', category: 'strategy' },
    
    // Adventure/RPG
    { id: 'browserquest', name: 'BrowserQuest', description: 'Multiplayer adventure RPG!', icon: '⚔️', color: '#f39c12', category: 'action' },
    { id: 'adarkroom', name: 'A Dark Room', description: 'Text-based survival adventure!', icon: '🕯️', color: '#2c3e50', category: 'strategy' },
    { id: 'minecraft', name: 'Minecraft Classic', description: 'Build and explore!', icon: '⛏️', color: '#8b4513', category: 'casual' },
    { id: 'astray', name: 'Astray', description: '3D maze adventure!', icon: '🌀', color: '#9b59b6', category: 'puzzle' },
    { id: 'the-house', name: 'The House', description: 'Spooky horror adventure!', icon: '🏚️', color: '#2c3e50', category: 'action' },
    ...
    // Misc/Unique
    { id: 'tower-game', name: 'Tower Stack', description: 'Stack blocks to build high!', icon: '🏗️', color: '#3498db', category: 'casual' },
    { id: 'towermaster', name: 'Tower Master', description: 'Master the tower building!', icon: '🗼', color: '#f39c12', category: 'casual' },
    { id: 'cookieclicker', name: 'Cookie Clicker', description: 'Click cookies! Get upgrades!', icon: '🍪', color: '#d35400', category: 'casual' },
    { id: 'particleclicker', name: 'Particle Clicker', description: 'Discover particles! CERN style!', icon: '⚛️', color: '#3498db', category: 'casual' },
    { id: 'trimps', name: 'Trimps', description: 'Incremental adventure game!', icon: '🐾', color: '#27ae60', category: 'strategy' },
    { id: 'dental-defender', name: 'Dental Defender', description: 'Protect teeth from germs!', icon: '🦷', color: '#ecf0f1', category: 'action' },
    { id: 'drill-bunny', name: 'Drill Bunny', description: 'Drill through the earth!', icon: '🐰', color: '#f39c12', category: 'action' },
    { id: 'fire-n-ice', name: 'Fire N Ice', description: 'Balance fire and ice!', icon: '🔥', color: '#e74c3c', category: 'puzzle' },
    { id: 'elemental-one', name: 'Elemental One', description: 'Master the elements!', icon: '🌊', color: '#3498db', category: 'puzzle' },
    { id: 'pushback', name: 'Pushback', description: 'Push enemies back!', icon: '👊', color: '#e74c3c', category: 'action' },
    { id: 'roadblocks', name: 'Roadblocks', description: 'Navigate through roadblocks!', icon: '🚧', color: '#f39c12', category: 'puzzle' },
    { id: 'shuttledeck', name: 'Shuttle Deck', description: 'Manage your shuttle deck!', icon: '🚀', color: '#3498db', category: 'strategy' },
    ...
    { id: 'edgenotfound', name: 'Edge Not Found', description: 'Find the edge!', icon: '🔍', color: '#3498db', category: 'puzzle' },
    { id: 'evilglitch', name: 'Evil Glitch', description: 'Fight the glitch!', icon: '👾', color: '#e74c3c', category: 'action' },
    ...
    { id: 'q1k3', name: 'Q1K3', description: 'Retro FPS action!', icon: '🔫', color: '#c0392b', category: 'action' },
